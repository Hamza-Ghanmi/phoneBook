...
<c:import url="header.jsp">
    <c:param name="title" value="Edit Contact"></c:param>
</c:import>
...
<main>
        <div class="container w-50">
            <div class="card mt-3">
                ...
                <div class="card-body">
                        <form:form id="form" cssClass="text-center" action="${pageContext.request.contextPath}/contacts/edit-contact" method="post" modelAttribute="contactDto" >
                            <form:hidden path="id" value="${contactDto.id}"></form:hidden>
